...
$getblogsByIdQuery = "select * from blogs where id = $id ";
$blogs = queryExecute($getblogsByIdQuery, false);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form id="add-user-form" action="<?= ADMIN_URL . 'blogs/save-edit.php'?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="image_url" value="<?= $blogs['image_url'] ?>">
                            </div>
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6 offset-md-3">
                                    <img src="<?= BASE_URL . $blogs['image'] ?>" id="preview-img" class="img-fluid">
                                </div>
                            </div>
                            <div class="form-group">
