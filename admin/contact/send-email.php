...
try {
    ...
    $updateContactQuery = "update contacts set status = '1', reply_for='$reply_for', reply_by='$id2' where id = '$id1'";
    queryExecute($updateContactQuery, false);
    header("location: " . ADMIN_URL . "contact/index.php?msg=Trả lời thành công");
    die;
