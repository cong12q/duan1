...
# Quy định constants
define('INDEX_URL', 'http://localhost/duan1/themeforest/sixtyone/');
define('BASE_URL', 'http://localhost/duan1/');
define('ADMIN_URL', BASE_URL . 'admin/');
define('MEMBER_URL', BASE_URL . 'member/');
define('PUBLIC_URL', BASE_URL . 'public/');
define('ADMIN_ASSET_URL', PUBLIC_URL . 'admin/');
define('THEME_ASSET_URL',  PUBLIC_URL . 'clean/');
...
function checkAdminLoggedIn(){
    ...
    if($_SESSION[AUTH]['role_id'] < 2){
        header('location: ' . INDEX_URL . 'index-2.php');
        die;
    }
}
