...
<!-- Mirrored from www.cssigniter.com/themeforest/sixtyone/location.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Mar 2020 05:12:27 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/php;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<!-- Basic Page Needs
	================================================== -->
	<meta charset="utf-8">
	<title>Location &ndash; SixtyOne</title>
				...
				<div class="col-md-12">
					<div id="top" class="group">
						<div class="row">
							...
							<div class="col-md-5">
								<ul id="misc"><li>Need assistance?</li><li>555-HOTEL-61</li><li><a href="https://www.cssigniter.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="741d1a121b34071d0c000d1b1a115a1c1b00">[email&#160;protected]</a></li></ul>
							</div>
						</div>
					</div>
...
<main class="container">
	<div class="row location">
		<div class="col-md-12">
			<div id="map" style="width:100%; height:300px; margin-bottom:25px"></div>
		</div><!-- .columns.twelve -->
	</div><!-- .row -->
	...
	<div class="row">
		<div class="col-md-8 col-md-push-4">
			...
			<div class="location-services">
				<dl>
					<dt class="service-title">Airport Directions</dt>
					<dd>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
					</dd>
					<dt class="service-title">Port</dt>
					<dd>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
					</dd>
					<dt class="service-title">Bus</dt>
					<dd>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
					</dd>
					<dt class="service-title">Train</dt>
					<dd>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
					</dd>
					<dt class="service-title">Car</dt>
					<dd>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
					</dd>
				</dl>
		...
		<div class="col-md-4 col-md-pull-8">
			<aside class="widget">
				<div class="aside-container">
					...
					<p>Pointblank Str. 14, 54321, California</p>
					<p>T. +123 456 5550-4<br />
						 F. +123 456 5555<br />
						 E. <a href="https://www.cssigniter.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a7cec9c1c8e7d4cedfd3dec8c9c289c8d5c0">[email&#160;protected]</a></p>
					<p>Open 24/7</p>
				</div>
			</aside>
		</div>
