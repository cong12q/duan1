...
<!-- Mirrored from www.cssigniter.com/themeforest/sixtyone/listing-4cols.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Mar 2020 05:12:21 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/php;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<!-- Basic Page Needs
	================================================== -->
	<meta charset="utf-8">
	<title>Listing 4 Columns &ndash; SixtyOne</title>
...
<div id="page">
	...
	<p class="mob-title">Listing 4 Columns</p>
</div>
	<div id="panel">
		<div class="container">
			<div class="row">
...
<main class="container">
	<div class="row">
		<div class="col-md-12">
			<h3 class="section-title">Listing 4 Columns</h3>
			<div class="row">
				<div class="col-md-3">
					<div class="item-listing">
						<div class="item-container">
							<h2 class="item-title"><a href="room.php">Suite I</a></h2>
							<h5 class="item-from">from $99 per night</h5>
							<figure class="item-thumb">
								<a href="room.php">
									<img width="690" height="450" src="images/room_thumb1.jpg"  alt="">
								</a>
							</figure>
				...
				<div class="col-md-3">
					<div class="item-listing">
						<div class="item-container">
							<h2 class="item-title"><a href="room.php">Suite II</a></h2>
							<h5 class="item-from">from $99 per night</h5>
							<figure class="item-thumb">
								<a href="room.php">
									<img width="690" height="450" src="images/room_thumb2.jpg"  alt="">
								</a>
							</figure>
							<a href="#" class="button">Read More</a>
						</div>
				...
				<div class="col-md-3">
					<div class="item-listing">
						<div class="item-container">
							<h2 class="item-title"><a href="room.php">Suite III</a></h2>
							<h5 class="item-from">from $99 per night</h5>
							<figure class="item-thumb">
								<a href="room.php">
									<img width="690" height="450" src="images/room_thumb3.jpg"  alt="">
								</a>
							</figure>
							<a href="#" class="button">Read More</a>
						</div>
				...
				<div class="col-md-3">
					<div class="item-listing">
						<div class="item-container">
							<h2 class="item-title"><a href="room.php">Standard Room</a></h2>
							<h5 class="item-from">from $99 per night</h5>
							<figure class="item-thumb">
								<a href="room.php">
									<img width="690" height="450" src="images/room_thumb4.jpg"  alt="">
								</a>
							</figure>
							<a href="#" class="button">Read More</a>
						</div>
				...
				<div class="col-md-3">
					<div class="item-listing">
						<div class="item-container">
							<h2 class="item-title"><a href="room.php">Standard Room II</a></h2>
							<h5 class="item-from">from $99 per night</h5>
							<figure class="item-thumb">
								<a href="room.php">
									<img width="690" height="450" src="images/room_thumb5.jpg"  alt="">
								</a>
							</figure>
							<a href="#" class="button">Read More</a>
						</div>
				...
				<div class="col-md-3">
					<div class="item-listing">
						<div class="item-container">
							<h2 class="item-title"><a href="room.php">Premium Double I</a></h2>
							<h5 class="item-from">from $99 per night</h5>
							<figure class="item-thumb">
								<a href="room.php">
									<img width="690" height="450" src="images/room_thumb6.jpg"  alt="">
								</a>
							</figure>
							<a href="#" class="button">Read More</a>
						</div>
				...
				<div class="col-md-3">
					<div class="item-listing">
						<div class="item-container">
							<h2 class="item-title"><a href="room.php">Premium Double II</a></h2>
							<h5 class="item-from">from $99 per night</h5>
							<figure class="item-thumb">
								<a href="room.php">
									<img width="690" height="450" src="images/room_thumb1.jpg"  alt="">
				...
				<div class="col-md-3">
					<div class="item-listing">
						<div class="item-container">
							<h2 class="item-title"><a href="room.php">Premium Double III</a></h2>
							<h5 class="item-from">from $99 per night</h5>
							<figure class="item-thumb">
								<a href="room.php">
									<img width="690" height="450" src="images/room_thumb2.jpg"  alt="">
